...
public record DeleteStorageCommand(int Id, string UserName)
    : IUseCase<bool>;

public record DeleteStorageCommandHandler(IStorageRepository StorageRepository, IProductRepository ProductRepository,
    ICommonRepository CommonRepository)
    : IUseCaseHandler<DeleteStorageCommand, bool>
{
